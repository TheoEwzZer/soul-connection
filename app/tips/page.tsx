...
const Advices: () => ReactElement = (): ReactElement => {
  ...
  }, [tips, i18n.language, blockTranslation]);
  ...
  useEffect(() => {
    ...
    translateQuery();
  }, [searchQuery, i18n.language, blockTranslation]);
        ...
        <div className="w-full max-w-[1400px] bg-white dark:bg-black p-4 sm:p-8 rounded-lg border shadow-md">
          <CardHeader>
            <div className="flex flex-col sm:flex-row justify-between items-center">
              <CardTitle className="text-center sm:text-left mb-4 sm:mb-0">{t("tips.title")}</CardTitle>
              <SearchBar
              ...
              >
                {blockTranslation ? "Activer la traduction" : "Bloquer la traduction"}
              </Button>
            </div>
